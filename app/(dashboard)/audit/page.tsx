...
export default function AuditPage() {
  ...
  useEffect(() => {
    ...
    fetchLogs()
  }, [session, sessionStatus, router, page, filterAction, filterObjectType, filterStartDate, filterEndDate])
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error('Sem permissão para acessar auditoria')
        router.push('/')
      }
    } catch (error) {
  ...
  const hasFilters = filterAction !== 'all' || filterObjectType !== 'all' ||
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-mono text-xs">{selectedLog.uuid}</p>
                </div>
              </div>
              <div>
